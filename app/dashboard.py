...
def _dashboard_snapshot() -> dict:
    ...
    return {
        "status": {
            ...
            "pnl_note": "Estimated mark-to-market P/L assumes submitted live limit orders fully filled at the configured limit price.",
        },
        "watching": watching,
...
<div class="wrap">
  ...
  <section class="panel active" id="current">
    <h2>Current watches & trades</h2><p class="note">Price watches refresh in the bot loop. Submitted live trades show estimated mark-to-market P/L.</p>
  ...
  <section class="panel" id="settings">
    ...
    <div class="readonly">
      ...
      <div class="ro"><span class="label">Auto trading</span><b id="roAuto">—</b></div>
